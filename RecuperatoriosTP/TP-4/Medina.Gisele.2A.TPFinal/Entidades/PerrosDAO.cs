...
namespace Entidades
{
    ...
    {
        private static string cadena_conexion;//para pasarle a AdoptanteDAO la misma cadaena de conexion
        private static SqlConnection conexion;
        private static SqlCommand comando;
        private static SqlDataReader lector;

        public static string Cadena_conexion { get => cadena_conexion; }
